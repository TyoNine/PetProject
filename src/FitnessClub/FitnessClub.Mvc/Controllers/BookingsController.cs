...
namespace FitnessClub.Mvc.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public IActionResult Edit(int? id)
        {
            ...
            ViewData["CustomerId"] = new SelectList(customerRepository.GetAll(), "Id", "Name", booking.CustomerId);
            ViewData["RoomId"] = new SelectList(gymRepository.GetAll(), "Id", "Description", booking.GymId);
            return View(booking);
        }
