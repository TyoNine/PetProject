...
namespace FitnessClub.Core
{
    public class BookingManager : IBookingManager
    {
        ...
        private IRepository<Gym> roomRepository;

        // Constructor injection
        public BookingManager(IRepository<Booking> bookingRepository, IRepository<Gym> roomRepository)
        {
        ...
        public int FindAvailableGym(DateTime startDate, DateTime endDate)
        {
